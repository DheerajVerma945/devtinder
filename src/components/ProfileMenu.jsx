...
function ProfileMenu({ userDoc }) {
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className="absolute top-0 h-screen left-0 w-1/3 md:w-1/4 bg-black shadow-lg rounded-md  z-30"
      >
        <div
          className="absolute  text-white  cursor-pointer right-2 top-2 text-xl"
